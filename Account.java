...
public abstract class Account {
   ...
   public void statementTransaction() {
      balance = (balance - this.monthlyFee()) + this.monthlyInterest();
   }
   ...
   /**
    * returns the unique identifier for the accounts returns withdraws for money
    * market returns 1 (true) or 0 (false) for Checking or Savings
    * 
    * @return an int
    */
   public abstract int uniqueAttribute();
}
