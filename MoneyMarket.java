...
public class MoneyMarket extends Account {
   ...
   /**
    * Constructor for MoneyMarket Accounts, with option to provide withdrawals
    * 
    * @param profile,  account owner
    * @param bal,      balance
    * @param date,     date account was opened
    * @param withdraws , if you want to set a withdraw amount.
    */
   public MoneyMarket(Profile profile, double bal, Date date, int withdraws) {
      super(profile, bal, date);
   ...
   @Override
   /**
    * Returns the current amount of withdrawals
